 ...
 */
class Interceptor extends \Magento\Eav\Model\Entity\Attribute\Set
{
    /**
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initFromSkeleton');
        if (!$pluginInfo) {
            return parent::initFromSkeleton($skeletonId);
        } else {
            return $this->___callPlugins('initFromSkeleton', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'organizeData');
        if (!$pluginInfo) {
            return parent::organizeData($data);
        } else {
            return $this->___callPlugins('organizeData', func_get_args(), $pluginInfo);
        }
    }
