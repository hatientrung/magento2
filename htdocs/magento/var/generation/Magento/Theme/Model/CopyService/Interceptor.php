<?php
namespace Magento\Theme\Model\CopyService;

/**
 * Interceptor class for @see \Magento\Theme\Model\CopyService
 */
class Interceptor extends \Magento\Theme\Model\CopyService
{
    /**
    ...
    {
        $this->___init();
        parent::__construct($filesystem, $fileFactory, $link, $updateFactory, $eventManager, $customization);
    }
     ...
     * {@inheritdoc}
     */
    public function copy(\Magento\Framework\View\Design\ThemeInterface $source, \Magento\Framework\View\Design\ThemeInterface $target)
    {
