...
/**
 * Interceptor class for @see \Magento\Sales\Model\Resource\Order
 */
class Interceptor extends \Magento\Sales\Model\Resource\Order
{
    /**
    ...
    public function __construct(\Magento\Framework\Model\Resource\Db\Context $context, \Magento\Sales\Model\Resource\Attribute $attribute, \Magento\Sales\Model\Increment $salesIncrement, \Magento\Sales\Model\Resource\Order\Handler\Address $addressHandler, \Magento\Sales\Model\Resource\Order\Handler\State $stateHandler, $resourcePrefix = null)
    {
        $this->___init();
        parent::__construct($context, $attribute, $salesIncrement, $addressHandler, $stateHandler, $resourcePrefix);
    }
