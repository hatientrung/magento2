...
class OrderStatusHistoryInterfacePersistor
{
     ...
     */
    public function __construct(\Magento\Sales\Model\Spi\OrderStatusHistoryResourceInterface $orderStatusHistoryInterfaceResource, \Magento\Sales\Api\Data\OrderStatusHistoryInterfaceFactory $orderStatusHistoryInterfaceFactory, \Magento\Framework\App\Resource $resource)
    {
    ...
    {
        $entity = $this->orderStatusHistoryInterfaceFactory->create();
        $this->orderStatusHistoryInterfaceResource->load($entity, $key);
        return $entity;
    }
