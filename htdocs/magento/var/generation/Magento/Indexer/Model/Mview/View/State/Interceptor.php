 ...
 */
class Interceptor extends \Magento\Indexer\Model\Mview\View\State
{
    /**
    ...
    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Indexer\Model\Resource\Mview\View\State $resource, \Magento\Indexer\Model\Resource\Mview\View\State\Collection $resourceCollection, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadByView');
        if (!$pluginInfo) {
            return parent::loadByView($viewId);
        } else {
            return $this->___callPlugins('loadByView', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setUpdated');
        if (!$pluginInfo) {
            return parent::setUpdated($updated);
        } else {
            return $this->___callPlugins('setUpdated', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVersionId');
        if (!$pluginInfo) {
            return parent::getVersionId();
        } else {
            return $this->___callPlugins('getVersionId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setVersionId');
        if (!$pluginInfo) {
            return parent::setVersionId($versionId);
        } else {
            return $this->___callPlugins('setVersionId', func_get_args(), $pluginInfo);
        }
    }
