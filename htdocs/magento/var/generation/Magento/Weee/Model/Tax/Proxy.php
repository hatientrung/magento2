 ...
 */
class Proxy extends \Magento\Weee\Model\Tax
{
    /**
    ...
    {
        return $this->_getSubject()->getProductWeeeAttributes($product, $shipping, $billing, $website, $calculateTax);
    }
    ...
    {
        return $this->_getSubject()->getDataSetDefault($key, $default);
    }
