...
/**
 * Proxy class for @see \Magento\Framework\App\Resource
 */
class Proxy extends \Magento\Framework\App\Resource
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Framework\\App\\Resource', $shared = true)
    {
     ...
     * {@inheritdoc}
     */
    public function getTableName($modelEntity, $connectionName = 'core_read')
    {
