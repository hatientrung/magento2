 ...
 */
class Interceptor extends \Magento\CatalogSearch\Model\Adapter\Mysql\Aggregation\DataProvider
{
    /**
    ...
    public function __construct(\Magento\Eav\Model\Config $eavConfig, \Magento\Framework\App\Resource $resource, \Magento\Framework\App\ScopeResolverInterface $scopeResolver, \Magento\Customer\Model\Session $customerSession)
    {
        $this->___init();
     ...
     * {@inheritdoc}
     */
    public function getDataSet(\Magento\Framework\Search\Request\BucketInterface $bucket, array $dimensions)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDataSet');
        if (!$pluginInfo) {
            return parent::getDataSet($bucket, $dimensions);
        } else {
