...
class Proxy implements \Magento\CatalogInventory\Api\StockStateInterface
{
    ...
    {
        return $this->_getSubject()->verifyStock($productId, $websiteId);
    }
    ...
    {
        return $this->_getSubject()->verifyNotification($productId, $websiteId);
    }
    ...
    {
        return $this->_getSubject()->checkQuoteItemQty($productId, $itemQty, $qtyToCheck, $origQty, $websiteId);
    }
    ...
    {
        return $this->_getSubject()->checkQty($productId, $qty, $websiteId);
    }
    ...
    {
        return $this->_getSubject()->suggestQty($productId, $qty, $websiteId);
    }
    ...
    {
        return $this->_getSubject()->getStockQty($productId, $websiteId);
    }
}
