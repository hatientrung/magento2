...
/**
 * Interceptor class for @see \Magento\Cms\Model\Resource\Page
 */
class Interceptor extends \Magento\Cms\Model\Resource\Page
{
    /**
    ...
    {
        $this->___init();
        parent::__construct($context, $date, $storeManager, $dateTime, $resourcePrefix);
    }
    ...
    public function getCmsPageTitleByIdentifier($identifier)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCmsPageTitleByIdentifier($identifier);
        } else {
            return $this->___callPlugins('getCmsPageTitleByIdentifier', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCmsPageTitleById($id)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCmsPageTitleById($id);
        } else {
            return $this->___callPlugins('getCmsPageTitleById', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCmsPageIdentifierById($id)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCmsPageIdentifierById($id);
        } else {
            return $this->___callPlugins('getCmsPageIdentifierById', func_get_args(), $pluginInfo);
        }
    }
