...
/**
 * Proxy class for @see \Magento\Store\Model\StoreManager
 */
class Proxy extends \Magento\Store\Model\StoreManager
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Store\\Model\\StoreManager', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->getGroups($withDefault, $codeKey);
    }
    ...
    {
        return $this->_getSubject()->clearWebsiteCache($websiteId);
    }
}
