 ...
 */
class Interceptor extends \Magento\Quote\Model\Quote\Item\ToOrderItem
{
    /**
    ...
    public function __construct(\Magento\Sales\Api\Data\OrderItemInterfaceFactory $orderItemFactory, \Magento\Framework\Object\Copy $objectCopyService, \Magento\Framework\Api\DataObjectHelper $dataObjectHelper)
    {
        $this->___init();
