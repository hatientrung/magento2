...
/**
 * Proxy class for @see \Magento\Backend\Model\Session
 */
class Proxy extends \Magento\Backend\Model\Session
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Backend\\Model\\Session', $shared = true)
    {
