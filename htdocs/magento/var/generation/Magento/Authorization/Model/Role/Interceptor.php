 ...
 */
class Interceptor extends \Magento\Authorization\Model\Role
{
    /**
    ...
    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Authorization\Model\Resource\Role $resource, \Magento\Authorization\Model\Resource\Role\Collection $resourceCollection, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRoleUsers');
        if (!$pluginInfo) {
            return parent::getRoleUsers();
        } else {
            return $this->___callPlugins('getRoleUsers', func_get_args(), $pluginInfo);
        }
    }
