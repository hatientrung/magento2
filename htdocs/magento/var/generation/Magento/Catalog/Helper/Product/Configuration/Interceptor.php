 ...
 */
class Interceptor extends \Magento\Catalog\Helper\Product\Configuration
{
    /**
    ...
    public function __construct(\Magento\Framework\App\Helper\Context $context, \Magento\Catalog\Model\Product\OptionFactory $productOptionFactory, \Magento\Framework\Filter\FilterManager $filter, \Magento\Framework\Stdlib\String $string)
    {
        $this->___init();
