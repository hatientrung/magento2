<?php
namespace Magento\Catalog\Model\Resource\Attribute;

/**
 * Interceptor class for @see \Magento\Catalog\Model\Resource\Attribute
 */
class Interceptor extends \Magento\Catalog\Model\Resource\Attribute
{
    /**
    ...
    public function __construct(\Magento\Framework\Model\Resource\Db\Context $context, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Eav\Model\Resource\Entity\Type $eavEntityType, \Magento\Eav\Model\Config $eavConfig, \Magento\Catalog\Model\Attribute\LockValidatorInterface $lockValidator, $resourcePrefix = null)
    {
        $this->___init();
        parent::__construct($context, $storeManager, $eavEntityType, $eavConfig, $lockValidator, $resourcePrefix);
    }
