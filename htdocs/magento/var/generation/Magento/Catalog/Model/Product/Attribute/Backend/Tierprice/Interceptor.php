 ...
 */
class Interceptor extends \Magento\Catalog\Model\Product\Attribute\Backend\Tierprice
{
    /**
    ...
    {
        $this->___init();
        parent::__construct($currencyFactory, $storeManager, $catalogData, $config, $catalogProductType, $groupManagement, $productAttributeTierprice);
    }
