 ...
 */
class Proxy implements \Magento\Catalog\Api\ProductRepositoryInterface
{
    /**
    ...
    {
        return $this->_getSubject()->get($sku, $editMode, $storeId);
    }
    ...
    {
        return $this->_getSubject()->getById($productId, $editMode, $storeId);
    }
