<?php
namespace Magento\Customer\Model\Resource\GroupRepository;

/**
 * Interceptor class for @see \Magento\Customer\Model\Resource\GroupRepository
 */
class Interceptor extends \Magento\Customer\Model\Resource\GroupRepository
{
    /**
    ...
    public function __construct(\Magento\Customer\Model\GroupRegistry $groupRegistry, \Magento\Customer\Model\GroupFactory $groupFactory, \Magento\Customer\Api\Data\GroupInterfaceFactory $groupDataFactory, \Magento\Customer\Model\Resource\Group $groupResourceModel, \Magento\Framework\Reflection\DataObjectProcessor $dataObjectProcessor, \Magento\Customer\Api\Data\GroupSearchResultsInterfaceFactory $searchResultsFactory, \Magento\Tax\Api\TaxClassRepositoryInterface $taxClassRepositoryInterface)
    {
        $this->___init();
        parent::__construct($groupRegistry, $groupFactory, $groupDataFactory, $groupResourceModel, $dataObjectProcessor, $searchResultsFactory, $taxClassRepositoryInterface);
    }
