...
/**
 * Proxy class for @see \Magento\Customer\Model\Resource\Customer
 */
class Proxy extends \Magento\Customer\Model\Resource\Customer
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Customer\\Model\\Resource\\Customer', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->setConnection($read, $write);
    }
    ...
    {
        return $this->_getSubject()->getWriteConnection();
    }
