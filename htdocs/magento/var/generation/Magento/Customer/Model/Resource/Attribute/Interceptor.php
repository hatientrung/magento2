...
/**
 * Interceptor class for @see \Magento\Customer\Model\Resource\Attribute
 */
class Interceptor extends \Magento\Customer\Model\Resource\Attribute
{
    /**
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getScopeValues');
        if (!$pluginInfo) {
            return parent::getScopeValues($object);
        } else {
            return $this->___callPlugins('getScopeValues', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getUsedInForms(\Magento\Framework\Model\AbstractModel $object)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUsedInForms');
        if (!$pluginInfo) {
            return parent::getUsedInForms($object);
        } else {
            return $this->___callPlugins('getUsedInForms', func_get_args(), $pluginInfo);
        }
    }
