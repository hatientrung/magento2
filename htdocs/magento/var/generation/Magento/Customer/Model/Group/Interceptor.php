 ...
 */
class Interceptor extends \Magento\Customer\Model\Group
{
    /**
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxClassName');
        if (!$pluginInfo) {
            return parent::getTaxClassName();
        } else {
            return $this->___callPlugins('getTaxClassName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'usesAsDefault');
        if (!$pluginInfo) {
            return parent::usesAsDefault();
        } else {
            return $this->___callPlugins('usesAsDefault', func_get_args(), $pluginInfo);
        }
    }
